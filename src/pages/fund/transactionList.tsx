...
export default function() {
  ...
  console.log('fourBasicInfo', fourBasicInfo);
  ...
  const mainContent = useMemo(()=>{
    if(
      ...
      !fourBasicInfo.basicInfos || fourBasicInfo.basicInfos.length === 0 ||
      !fourBasicInfo.unitPrices || fourBasicInfo.unitPrices.length === 0
    ){
      return null;
    }
    return (
    <div style={{display: 'flex', flexDirection: 'column'}}>
      {Array.isArray(transactionSets) &&
        <AntdBaseTable
